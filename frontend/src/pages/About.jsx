  ...
  return (
    ...
    <div className='my-10 flex flex-col md:flex-row gap-16'>
      ...
      <div className='flex flex-col justify-center gap-6 md:w-2/4 text-gray600'>
         <p className='text-gray-700'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint quod ratione id illo pariatur, maxime ullam, quam libero sapiente iusto veritatis doloribus nesciunt numquam consectetur quibusdam, recusandae quae tenetur quas!</p>
   ...
   <Title  text1={'WHY'} text2={'CHOOSE US '} />
    ...
    <div className='flex flex-col text-sm md:flex-row mb-20 '>
         <div className='border px-10 md:px-10 py-16 flex-col gap-5'>
          ...
          <p className='text-gray-700 my-2'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eum eveniet iusto fugit fuga vero sequi ratione at magnam omnis dolorem dicta tenetur et repellat odio quis a, nemo dolore amet.</p>
          </div>  
           <div className='border px-10 md:px-10 py-16 flex-col gap-5'>
          <b>convenience:</b>
          <p className='text-gray-700 my-2'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eum eveniet iusto fugit fuga vero sequi ratione at magnam omnis dolorem dicta tenetur et repellat odio quis a, nemo dolore amet.</p>
